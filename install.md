# kidney-segmentation-unet guide installation
...
activate kidney_segmentation_unet
```
...
To move beyond notebook prototyping, all reusable code should go into the `kidney_segmentation_unet/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `kidney_segmentation_unet` folder and use the modules inside your notebooks :
...
```python
from kidney_segmentation_unet.utils.paths import data_dir
data_dir()
```
